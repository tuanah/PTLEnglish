...
{
	partial class UC_Learn_Shuffle
	{
		/// <summary> 
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UC_Learn_Shuffle));
			...
			this.lbl_Key.BackColor = System.Drawing.SystemColors.ButtonHighlight;
			...
			this.lbl_Key.Location = new System.Drawing.Point(10, 10);
			...
			this.Name = "UC_Learn_Shuffle";
			this.Size = new System.Drawing.Size(548, 184);
			this.Load += new System.EventHandler(this.UC_Learn_Shuffle_Load);
